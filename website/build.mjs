...
writeFileSync(
  join(repoRoot, "server", "src", "console", "landscape.gen.html"),
...
// (server/src/console/stack.html, served by the gateway binary). To keep them
...
// derived artifact (server/src/console/landscape.gen.html) that the server injects
