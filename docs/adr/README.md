...
| [0062](0062-durable-agent-session-resume.md) | Durable agent-session resume: authoritative session log + harness replay contract + mind/world checkpoint | Proposed | 2026-08-19 |
