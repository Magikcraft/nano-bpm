 ...
 */
export async function layoutBpmn(bpmnXml) {
    let layoutProcess;
    try {
        ...
        throw new Error('layoutBpmn requires the optional peer dependency "bpmn-auto-layout". ' +
 ...
 */
export function declarativeToLayoutedBpmn(flow) {
