...
const EMBEDDING_REAL_DOC_REF =
  "README.md#real-ai-adapters — EmbeddingModelAdapter: " +
  "HostedEmbeddingAdapter (src/adapters/real/hosted.ts), LocalEmbeddingAdapter (src/adapters/real/local.ts)";

/** docRef for the real chat/judge backends (hosted + local; optional image = vision). */
const CHAT_REAL_DOC_REF =
  "README.md#real-ai-adapters — ChatModelAdapter: " +
  "HostedChatModelAdapter (src/adapters/real/hosted.ts), LocalChatModelAdapter (src/adapters/real/local.ts)";
