// @nanobpm/ai-assert — the AI-assertion surface (issue #297), lifted out of
// @nanobpm/urban-testkit's `/ai` subpath so it is reusable in any app (issue #894, S3).
//
// AI-judge & semantic-similarity assertions. This barrel is the single public entry for
// the package and now exports the full shipped surface — the
