...
export const testengine_throwError: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
...
export const testengine_updateAgentInstance: (a: number, b: number, c: number, d: number) => void;
export const testengine_updateRetries: (a: number, b: number, c: number, d: number, e: number) => void;
