 ...
 */
export type AgentInstanceHistoryRoleEnum = 'USER' | 'ASSISTANT' | 'TOOL_RESULT' | 'CONFIGURATION';

/**
 * AgentInstanceHistoryRoleEnum property with full advanced search capabilities.
 */
export type AgentInstanceHistoryRoleFilterProperty = AgentInstanceHistoryRoleEnum | AdvancedAgentInstanceHistoryRoleFilter;
 ...
 */
export type AgentInstanceStatusEnum = 'UNKNOWN' | 'COMPLETED' | 'IDLE' | 'INITIALIZING' | 'THINKING' | 'TOOL_CALLING' | 'TOOL_DISCOVERY';
 ...
 *
 */
export type AgentInstanceUpdateStatusEnum = 'IDLE' | 'THINKING' | 'TOOL_CALLING' | 'TOOL_DISCOVERY';
...
export type _1AgentInstances = unknown;

export type _1AgentInstances1Search = unknown;

export type _1AgentInstances1AgentInstanceKey = unknown;

export type _1AgentInstances1AgentInstanceKey1History1Search = unknown;
...
export type _1AuditLogs1Search = unknown;

export type _1AuditLogs1AuditLogKey = unknown;
...
export type _1Authentication1Me = unknown;
 ...
 */
export type AuthorizationKey = LongKey;
...
export type _1Authorizations = unknown;

export type _1Authorizations1Search = unknown;

export type _1Authorizations1AuthorizationKey = unknown;
...
export type _1BatchOperationItems1Search = unknown;

export type _1BatchOperations1Search = unknown;

export type _1BatchOperations1BatchOperationKey = unknown;

export type _1BatchOperations1BatchOperationKey1Cancellation = unknown;

export type _1BatchOperations1BatchOperationKey1Resumption = unknown;

export type _1BatchOperations1BatchOperationKey1Suspension = unknown;
...
export type _1Clock = unknown;

export type _1Clock1Reset = unknown;
...
export type _1ClusterVariables1Global = unknown;

export type _1ClusterVariables1Global1Name = unknown;

export type _1ClusterVariables1Search = unknown;

export type _1ClusterVariables1Tenants1TenantId = unknown;

export type _1ClusterVariables1Tenants1TenantId1Name = unknown;
...
export type _1Status = unknown;

export type _1Topology = unknown;
 ...
 */
export type ConditionalEvaluationKey = LongKey;
...
export type _1Conditionals1Evaluation = unknown;
...
export type _1DecisionDefinitions1Evaluation = unknown;

export type _1DecisionDefinitions1Search = unknown;

export type _1DecisionDefinitions1DecisionDefinitionKey = unknown;

export type _1DecisionDefinitions1DecisionDefinitionKey1Xml = unknown;
...
export type _1DecisionInstances1Deletion = unknown;

export type _1DecisionInstances1Search = unknown;

export type _1DecisionInstances1DecisionEvaluationInstanceKey = unknown;

export type _1DecisionInstances1DecisionEvaluationKey1Deletion = unknown;
...
export type _1DecisionRequirements1Search = unknown;

export type _1DecisionRequirements1DecisionRequirementsKey = unknown;

export type _1DecisionRequirements1DecisionRequirementsKey1Xml = unknown;
 ...
 */
export type DeploymentKey = LongKey;
...
export type _1Deployments = unknown;

export type _1Resources1Search = unknown;

export type _1Resources1ResourceKey = unknown;

export type _1Resources1ResourceKey1Content = unknown;

export type _1Resources1ResourceKey1Content1Binary = unknown;

export type _1Resources1ResourceKey1Deletion = unknown;
...
export type _1Documents = unknown;

export type _1Documents1Batch = unknown;

export type _1Documents1DocumentId = unknown;

export type _1Documents1DocumentId1Links = unknown;
 ...
 */
export type WaitStateElementTypeEnum = 'AD_HOC_SUB_PROCESS' | 'AD_HOC_SUB_PROCESS_INNER_INSTANCE' | 'BOUNDARY_EVENT' | 'BUSINESS_RULE_TASK' | 'CALL_ACTIVITY' | 'END_EVENT' | 'EVENT_BASED_GATEWAY' | 'EVENT_SUB_PROCESS' | 'EXCLUSIVE_GATEWAY' | 'INCLUSIVE_GATEWAY' | 'INTERMEDIATE_CATCH_EVENT' | 'INTERMEDIATE_THROW_EVENT' | 'MANUAL_TASK' | 'MULTI_INSTANCE_BODY' | 'PARALLEL_GATEWAY' | 'PROCESS' | 'RECEIVE_TASK' | 'SCRIPT_TASK' | 'SEND_TASK' | 'SEQUENCE_FLOW' | 'SERVICE_TASK' | 'START_EVENT' | 'SUB_PROCESS' | 'TASK' | 'UNKNOWN' | 'UNSPECIFIED' | 'USER_TASK';

/**
 * Element type property with full advanced search capabilities.
 */
export type WaitStateElementTypeFilterProperty = WaitStateElementTypeEnum | AdvancedWaitStateElementTypeFilter;
 ...
 */
export type WaitStateTypeFilterProperty = WaitStateTypeEnum | AdvancedWaitStateTypeFilter;

export type _1ElementInstances1AdHocActivities1AdHocSubProcessInstanceKey1Activation = unknown;

export type _1ElementInstances1Search = unknown;

export type _1ElementInstances1WaitStates1Search = unknown;

export type _1ElementInstances1ElementInstanceKey = unknown;

export type _1ElementInstances1ElementInstanceKey1Incidents1Search = unknown;

export type _1ElementInstances1ElementInstanceKey1Variables = unknown;
...
export type _1Expression1Evaluation = unknown;
...
export type _1Forms1FormKey = unknown;
 ...
 */
export type GlobalListenerSourceFilterProperty = GlobalListenerSourceEnum | AdvancedGlobalListenerSourceFilter;
 ...
 */
export type GlobalTaskListenerEventTypeFilterProperty = GlobalTaskListenerEventTypeEnum | AdvancedGlobalTaskListenerEventTypeFilter;
...
export type _1GlobalTaskListeners = unknown;

export type _1GlobalTaskListeners1Search = unknown;

export type _1GlobalTaskListeners1Id = unknown;
...
export type _1Groups = unknown;

export type _1Groups1Search = unknown;

export type _1Groups1GroupId = unknown;

export type _1Groups1GroupId1Clients1Search = unknown;

export type _1Groups1GroupId1Clients1ClientId = unknown;

export type _1Groups1GroupId1MappingRules1Search = unknown;

export type _1Groups1GroupId1MappingRules1MappingRuleId = unknown;

export type _1Groups1GroupId1Roles1Search = unknown;

export type _1Groups1GroupId1Users1Search = unknown;

export type _1Groups1GroupId1Users1Username = unknown;
 ...
 */
export type ClusterVariableName = string;
 ...
 */
export type ElementIdFilterProperty = ElementId | AdvancedElementIdFilter;
 ...
 */
export type ProcessDefinitionIdFilterProperty = ProcessDefinitionId | AdvancedProcessDefinitionIdFilter;
...
export type _1Incidents1Search = unknown;

export type _1Incidents1Statistics1ProcessInstancesByDefinition = unknown;

export type _1Incidents1Statistics1ProcessInstancesByError = unknown;

export type _1Incidents1IncidentKey = unknown;

export type _1Incidents1IncidentKey1Resolution = unknown;
...
export type _1Jobs1Statistics1ByTypes = unknown;

export type _1Jobs1Statistics1ByWorkers = unknown;

export type _1Jobs1Statistics1Errors = unknown;

export type _1Jobs1Statistics1Global = unknown;

export type _1Jobs1Statistics1TimeSeries = unknown;
 ...
 * The listener event type of the job.
 */
export type JobListenerEventTypeEnum = 'ASSIGNING' | 'BEFORE_ALL' | 'CANCEL' | 'CANCELING' | 'COMPLETING' | 'CREATING' | 'END' | 'START' | 'UNSPECIFIED' | 'UPDATING';
...
export type _1Jobs1JobKey = unknown;

export type _1Jobs1JobKey1Completion = unknown;
 ...
 */
export type AgentInstanceKey = LongKey;

/**
 * AgentInstanceKey property with full advanced search capabilities.
 */
export type AgentInstanceKeyFilterProperty = AgentInstanceKey | AdvancedAgentInstanceKeyFilter;

/**
 * System-generated key for an audit log entry.
 */
export type AuditLogKey = LongKey;
 ...
 */
export type DecisionDefinitionKey = LongKey;
 ...
 */
export type DecisionEvaluationKey = LongKey;
 ...
 */
export type DecisionInstanceKey = LongKey;

/**
 * System-generated key for a deployed decision requirements definition.
 */
export type DecisionRequirementsKey = LongKey;
 ...
 */
export type ElementInstanceKey = LongKey;
 ...
 */
export type IncidentKey = LongKey;

/**
 * System-generated key for a job.
 */
export type JobKey = LongKey;
 ...
 */
export type ProcessDefinitionKey = LongKey;
 ...
 */
export type ProcessInstanceKey = LongKey;
 ...
 */
export type UserTaskKey = LongKey;

/**
 * System-generated key for a variable.
 */
export type VariableKey = LongKey;
...
export type _1MappingRules = unknown;

export type _1MappingRules1Search = unknown;

export type _1MappingRules1MappingRuleId = unknown;
 ...
 */
export type MessageKey = LongKey;
 ...
 */
export type MessageSubscriptionKey = LongKey;
 ...
 *
 */
export type MessageSubscriptionTypeEnum = 'START_EVENT' | 'PROCESS_EVENT';
...
export type _1CorrelatedMessageSubscriptions1Search = unknown;

export type _1MessageSubscriptions1Search = unknown;

export type _1Messages1Correlation = unknown;

export type _1Messages1Publication = unknown;
...
export type _1ProcessDefinitions1Search = unknown;

export type _1ProcessDefinitions1Statistics1MessageSubscriptions = unknown;

export type _1ProcessDefinitions1Statistics1ProcessInstances = unknown;

export type _1ProcessDefinitions1Statistics1ProcessInstancesByVersion = unknown;

export type _1ProcessDefinitions1ProcessDefinitionKey = unknown;

export type _1ProcessDefinitions1ProcessDefinitionKey1Form = unknown;

export type _1ProcessDefinitions1ProcessDefinitionKey1Statistics1ElementInstances = unknown;

export type _1ProcessDefinitions1ProcessDefinitionKey1Xml = unknown;
...
export type _1ProcessInstances = unknown;

export type _1ProcessInstances1Cancellation = unknown;

export type _1ProcessInstances1Deletion = unknown;

export type _1ProcessInstances1IncidentResolution = unknown;

export type _1ProcessInstances1Migration = unknown;

export type _1ProcessInstances1Modification = unknown;

export type _1ProcessInstances1Search = unknown;

export type _1ProcessInstances1ProcessInstanceKey = unknown;

export type _1ProcessInstances1ProcessInstanceKey1CallHierarchy = unknown;

export type _1ProcessInstances1ProcessInstanceKey1Cancellation = unknown;

export type _1ProcessInstances1ProcessInstanceKey1Deletion = unknown;

export type _1ProcessInstances1ProcessInstanceKey1IncidentResolution = unknown;

export type _1ProcessInstances1ProcessInstanceKey1Incidents1Search = unknown;

export type _1ProcessInstances1ProcessInstanceKey1Migration = unknown;
...
export type _1Roles = unknown;

export type _1Roles1Search = unknown;

export type _1Roles1RoleId = unknown;

export type _1Roles1RoleId1Clients1Search = unknown;

export type _1Roles1RoleId1Clients1ClientId = unknown;

export type _1Roles1RoleId1Groups1Search = unknown;

export type _1Roles1RoleId1Groups1GroupId = unknown;

export type _1Roles1RoleId1MappingRules1Search = unknown;

export type _1Roles1RoleId1MappingRules1MappingRuleId = unknown;

export type _1Roles1RoleId1Users1Search = unknown;

export type _1Roles1RoleId1Users1Username = unknown;
...
export type _1Setup1User = unknown;
 ...
 */
export type SignalKey = LongKey;

export type _1Signals1Broadcast = unknown;
...
export type _1System1Configuration = unknown;

export type _1System1UsageMetrics = unknown;
...
export type _1Tenants = unknown;

export type _1Tenants1Search = unknown;

export type _1Tenants1TenantId = unknown;

export type _1Tenants1TenantId1Clients1Search = unknown;

export type _1Tenants1TenantId1Clients1ClientId = unknown;

export type _1Tenants1TenantId1Groups1Search = unknown;

export type _1Tenants1TenantId1Groups1GroupId = unknown;

export type _1Tenants1TenantId1MappingRules1Search = unknown;

export type _1Tenants1TenantId1MappingRules1MappingRuleId = unknown;

export type _1Tenants1TenantId1Roles1Search = unknown;

export type _1Tenants1TenantId1Roles1RoleId = unknown;

export type _1Tenants1TenantId1Users1Search = unknown;

export type _1Tenants1TenantId1Users1Username = unknown;
...
export type _1UserTasks1Search = unknown;

export type _1UserTasks1UserTaskKey = unknown;

export type _1UserTasks1UserTaskKey1Assignee = unknown;

export type _1UserTasks1UserTaskKey1Assignment = unknown;

export type _1UserTasks1UserTaskKey1AuditLogs1Search = unknown;

export type _1UserTasks1UserTaskKey1Completion = unknown;

export type _1UserTasks1UserTaskKey1EffectiveVariables1Search = unknown;

export type _1UserTasks1UserTaskKey1Form = unknown;

export type _1UserTasks1UserTaskKey1Variables1Search = unknown;
...
export type _1Users = unknown;

export type _1Users1Search = unknown;

export type _1Users1Username = unknown;
...
export type _1Variables1Search = unknown;

export type _1Variables1VariableKey = unknown;
