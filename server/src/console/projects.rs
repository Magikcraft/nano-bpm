...
const URBAN_DENO_JSON: &str = r#"{
  "imports": { "@nanobpm/nano-sdk": "npm:@nanobpm/nano-sdk@^1", "@nanobpm/worker": "./.nanobpm/worker-sdk.ts", "@nanobpm/llm": "./.nanobpm/llm-worker.ts", "@nanobpm/data": "./.nanobpm/data-sdk.ts", "@nanobpm/domain": "./.nanobpm/domain.ts", "@lib/": "./lib/" },
  "tasks": {
    "start": "deno run --allow-net --allow-read --allow-write --allow-env main.ts"
  }
}
